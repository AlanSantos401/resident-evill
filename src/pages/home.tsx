...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section>
        <div className='flex flex-col justify-center pt-14 p-8'>
          <img className='w-xl' src={resident} alt="nome-resident-evill" />

          <h2 className='text-3xl mb-4 text-mauve-300 leading-relaxed tracking-wider'>
            ARQUIVOS OFICIAIS DA SAGA
          </h2>

          <p className='text-xl text-mauve-300'>
          ...
          <div className="flex gap-4 mt-8">
            ...
            <button
              ...
              className="group relative flex items-center gap-2 px-6 py-4 cursor-pointer 
            ...
            <button
              ...
              className="relative flex items-center gap-2 px-8 py-4 cursor-pointer 
              text-white uppercase overflow-hidden
